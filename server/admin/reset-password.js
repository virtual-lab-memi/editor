Accounts.emailTemplates.resetPassword.siteName = function() {"Application Name"};
Accounts.emailTemplates.resetPassword.from     = function() { "Application Name <admin@application.com>"};
Accounts.emailTemplates.resetPassword.subject  = function() {"[Application Name] Reset Your Password"};
